...
const Profile: React.FC<ProfileProps> = ({ toggleNavbar }) => {
  return (
    <section className="flex flex-col h-full">
      ...
      <section className="flex flex-col md:flex-row justify-center h-inherit py-4 sm:h-5/6 align-middle">
        ...
        <div className="flex content-center justify-center h-full items-center px-10 py-2">
